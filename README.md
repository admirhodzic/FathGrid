...
<tr><td>serverURL</td><td>templated string URL for data retrieval. eg: '/posts?_page=${page}&_limit=${size}&_sort=${sort}&_order=${order}&q=${search}&${filters}'</td><td>undefined</td></tr>
